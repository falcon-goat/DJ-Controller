{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 283.0, 476.0, 1367.0, 399.0 ],
		"bglocked" : 0,
		"defrect" : [ 283.0, 476.0, 1367.0, 399.0 ],
...
, 			{
				"box" : 				{
					...
					"args" : [ 1 ],
					"name" : "ARC-Panel-Decks-DeckView-0.0-000-r0.maxpat",
...
, 			{
				"box" : 				{
					...
					"args" : [  ],
					"outlettype" : [ "" ],
					"name" : "ARC-Panel-Decks-DeckSwitches-0.0-000-r1.maxpat",
